...
export class EditEmpModal extends Component{
    ...
    handleSubmit(event){
        ...
        fetch(process.env.REACT_APP_API+'employee',{
            ...
            body:JSON.stringify({
                EmplyeeID:event.target.EmployeeID.value,
    ...
    <Modal.Body>
        ...
        <Row>
            <Col sm={6}>
                ...
                <Form.Group controlId="EmplyeeID">
                        <Form.Label>EmployeeId</Form.Label>
                        <Form.Control type="text" name="EmplyeeID" required 
                    ...
                    <Form.Group controlId="DateJoin">
                        <Form.Label>DateJoin</Form.Label>
                        <Form.Control 
                        type="date"
                        name="DateJoin"
                        required
                        placeholder="DateJoin"
